        ...
        <nav class="navbar py-4 navbar-expand-lg navbar-light pn">
            ...
            <div class="collapse navbar-collapse">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="ml-5" href="<?= site_url('/auth') ?>" role="button">Login</a>
                    </li>
                </ul>
            </div>

        </nav>
        <h2 class="login text-center">Registrasi Akun</h2>
        <div class="d-flex justify-content-center">
            <div class="login-form">
                <form method="post" action="<?= site_url('/auth/register') ?>">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control" name="password2" id="password" placeholder="Password Confirmation...">
                    </div>
                    <div class="form-group">
